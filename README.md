# This script can be tested by going to nutisport.eu, then clicking one of the buttons on the left, then clicking one of the houses and then clicking the button labeled "Alusta".
